...
function Ok()
{
 var ext=GetE('txtUrl').value;
 var ini=ext.length-3;
 var fin=ext.length;
 var otra=ext.substring(ini,fin);
 if(otra=="swf")
 {	
	var swf1="<object classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000' codebase='http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0' width='ancho_swf' height='alto_swf'><param name='movie' value='"+ GetE('txtUrl').value +"'><param name='quality' value='high'>";;
	var swf2="<embed src='../../../edt_admin/editor/dialog/fck_image/"+ GetE('txtUrl').value +"' quality='high' pluginspage='http://www.macromedia.com/go/getflashplayer' type='application/x-shockwave-flash' width='ancho_swf' height='alto_swf'></embed></object>";;
	var ancho=document.getElementById('ancho').value;
	var alto=document.getElementById('alto').value;
	var swf1=swf1.replace('alto_swf',alto); 
	var swf1=swf1.replace('ancho_swf',ancho); 
	var swf2=swf2.replace('alto_swf',alto); 
	var swf2=swf2.replace('ancho_swf',ancho); 
	var swf = swf1+""+swf2;
			oImage = FCK.EditorDocument.createElement( 'DIV' ) ;
			oImage.innerHTML=swf;
			oImage = FCK.InsertElementAndGetIt( oImage ) ;
			oImage.innerHTML=swf1;
			oImage.innerHTML=swf2;
	return true;
 }else{
...
function UpdatePreview()
{
	...
	if(otra!="swf")
	{
		...
		document.getElementById('tamano').style.visibility="visible";
	}
}
...
function guardar()
{
	...
	var swf2=swf2.replace('ancho_swf',ancho);
	var swf = swf1+""+swf2;
	document.getElementById('preview').innerHTML=swf;
	document.getElementById('tamano').style.visibility="hidden";
	document.getElementById('txtWidth').value=ancho;
	document.getElementById('txtHeight').value=alto;
}
