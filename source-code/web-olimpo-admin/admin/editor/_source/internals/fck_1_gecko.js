...
FCK.SetHTML = function( html, forceWYSIWYG )
{
	if ( forceWYSIWYG || FCK.EditMode == FCK_EDITMODE_WYSIWYG )
	{
		...
		if ( FCKConfig.FullPage && FCKRegexLib.BodyContents.test( html ) )
		{
			...
			html = html.replace( FCKRegexLib.HeadCloser, '<link href="../../../edt_admin/editor/_source/internals/' + FCKConfig.BasePath + 'css/fck_internal.css' + '" rel="stylesheet" type="text/css" _fcktemp="true" /></head>' ) ;
		...
		else
		{
			var sHtml = 
				...
				'<head><title></title>' +
				'<link href="../../../edt_admin/editor/_source/internals/' + FCKConfig.EditorAreaCSS + '" rel="stylesheet" type="text/css" />' +
				'<link href="../../../edt_admin/editor/_source/internals/' + FCKConfig.BasePath + 'css/fck_internal.css' + '" rel="stylesheet" type="text/css" _fcktemp="true" />' ;
