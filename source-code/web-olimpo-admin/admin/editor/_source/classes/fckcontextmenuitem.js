...
FCKContextMenuItem.prototype.CreateTableRow = function( targetTable )
{
	...
	if ( this.HasIcon ) oCell.innerHTML = '<img alt="" src="../../../edt_admin/editor/_source/classes/' + FCKConfig.SkinPath + 'toolbar/' + this.Command.Name.toLowerCase() + '.gif" width="21" height="20" unselectable="on">' ;
...
<tr class="CM_Disabled">
	<td class="CM_Icon"><img alt="" src="../../../edt_admin/editor/_source/classes/icons/cut.gif" width="21" height="20" unselectable="on"></td>
