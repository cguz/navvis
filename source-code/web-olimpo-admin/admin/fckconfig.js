...
FCKConfig.ToolbarSets["Default"] = [
	['Source','Preview','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','Cut','Copy','Paste','PasteText','PasteWord','-','Print','-','Find','Replace','-','SelectAll','RemoveFormat'],
...
FCKConfig.ImageBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Connector=connectors/php/connector.php' ;
