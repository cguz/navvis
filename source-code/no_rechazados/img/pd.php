...
class Imagen {
	...
	private function error($msg) {
	    ...
	    imagestring ($this->source, 5, 19, 20, "", $text_color_red);
	    imagestring ($this->source, 3, 16, 65, $msg, $text_color_blue); 
	...
	public function doSave($destination,$quality=null) {
		$quality = (is_numeric($quality) and $quality <= 100 and $quality >= 1) ? intval($quality) : 100;
		Header("Content-type: image/".$this->type);
		$f2 = $this->f2;
