...
?>
<div id="contenido">
<div id="navegacion2"> <a href="principal.php">inicio</a> &gt; <a href="editar_eliminar_proyectos.php">actualizar concursos</a> &gt; eliminar proyecto</div>
...
<p><img src="<?php echo $Dato[Imagen]; ?>" width="150"><br /></p>
...
<table width="100%"  border="0" cellpadding="5" cellspacing="5">
      ...
      <tr>
        <td width="47%"><div align="right"><a href="editar_eliminar_concurso.php?cadena=<?php echo $cadena; ?>&primero=<?php echo $primero; ?>&IdProyecto=<?php echo $IdProyecto; ?>&ban=get&eliminar=SI"> SI </a> </div></td>
        <td width="50%"><div align="left"><a href="editar_eliminar_concurso.php?cadena=<?php echo $cadena; ?>&primero=<?php echo $primero; ?>&IdProyecto=<?php echo $IdProyecto; ?>&ban=get">NO </a></div></td>
      </tr>
    </table>
    </span>
</div>
