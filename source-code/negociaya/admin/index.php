                ...
                <tr <?php if ($info['revisado'] == "0") print "class='norevisado'"; ?>>
                    ...
                    <?php
                        if ($info['total_imagenes'] > 0)
                        {
                            ...
                            {
                    ?>
                    <a target='_blank' href="./ver_anuncio.php?id=<?php print $info['id'] ?>"><img class="imagen" src="<?php print "../lib/img_mostrar.php?imagen=".base64_encode($info['ruta'])."&ancho=$ancho_thumb&alto=$alto_thumb" ?>" width="<?php print $ancho_thumb ?>" height="<?php print $alto_thumb ?>" /></a>
                    <?php
                            }
                            else
                            {
