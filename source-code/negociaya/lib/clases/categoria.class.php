...
class Categoria
{
    ...
    // Busca un Categoria en la BD a través del Id del objeto actual y coloca estos valores en los atributos del objeto
    ...
    // Retorna un array de objetos Categoria con los valores en BD, se puede usar paginación
